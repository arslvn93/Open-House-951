const config = {
  "property": {
    ...
    "heroSubtitle": "Bonus bedroom, 2-acre lot, and a sun-soaked main living room! Brand new deck being built. Peace and quiet, yet still a short drive to Kemptville. Register to receive the complete property & neighbourhood info package, virtual tour, floor plans, and comparables.",
